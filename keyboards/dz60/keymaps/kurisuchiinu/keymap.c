...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LSFT , KC_LSFT , KC_Z    , KC_X    , KC_C      , KC_V      , KC_B           , KC_N    , KC_M    , KC_COMM  , KC_DOT   , KC_SLSH , KC_RSFT  , ESC_FN2 ,
        KC_LCTRL , KC_LGUI , KC_LALT , KC_SPACE , KC_KANA , FN1 , KC_LEFT , KC_RIGHT , XXXXXXX , KC_VOLU , KC_VOLD) ,
