...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LSFT , KC_KANA , KC_Z    , KC_X    , KC_C      , KC_V      , KC_B           , KC_N    , KC_M    , KC_COMM  , KC_DOT   , KC_SLSH , KC_RSFT  , FN1 ,
        KC_LCTRL , KC_LGUI , KC_LALT , SPACE_FN1 , SPACE_FN2 , SPACE_FN3 , KC_DOWN , KC_UP, XXXXXXX , KC_LEFT , KC_RIGHT) ,
